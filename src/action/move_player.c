...
/*   Updated: 2022/11/08 11:44:36 by aandric          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	move_up(t_data **data)
{
	...
	next_x_i = (*data)->player->x + (*data)->player->ray_coef_x * (STEP_COEF + HIT_BOX);
	next_y_i = (*data)->player->y - (*data)->player->ray_coef_y * (STEP_COEF + HIT_BOX);
	// next_x_i = (int)(next_x);
	// next_y_i = (int)(next_y);
